...
class App(QWidget):
    ...
    def initUI(self):
        ...
        self.lbl_logo.setPixmap(QtGui.QPixmap('most_centrifuge_logo.png'))
    ...
    def btn_CAM_0_click_function(self):
        ...
        out = cv2.VideoWriter('out_cam_processed.avi',cv2.VideoWriter_fourcc('M','J','P','G'), 10, (frame_width,frame_height))
...
# ---------------------------end of btn_OPEN_VID_click_function-----------------------------------------------------------------
    ...
    def _update_canvas(self):
        ...
        t = np.linspace(0, self.graph_x_size-1, self.graph_x_size)
        self._dynamic_ax.clear()

        # Shift the sinusoid as a function of time.
        self._dynamic_ax.plot(t,self.rpm2,color='#696969')
        self._dynamic_ax.axvline(x=self.rotations,linewidth=2,c='r')
        self._dynamic_ax.fill_between(t,0,self.rpm2,facecolor='#708090')

        #self._dynamic_ax2.plot(t,self.rcf2,color='#FF7F50')
        #self._dynamic_ax2.fill_between(t,0,self.rcf2,facecolor='#FF7F50')
        ...
        self._dynamic_ax.legend(['Tubes RPM'])
